...
Bookmark.prototype.showBookmarkList = function(){
	...
	$bookmarkBox.html('<div class="control_bar"><button type="button" class="close" id="closebookmarkBox" data-dismiss="modal" aria-hidden="true">×</button></div><div id="boxList"></div>')
